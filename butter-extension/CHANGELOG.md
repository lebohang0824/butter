...
- **Updated documentation philosophy** — README, documentation, docs HTML, and `.butter` examples now present Butter as an implementation-agnostic language for communicating application intent to AI agents.
