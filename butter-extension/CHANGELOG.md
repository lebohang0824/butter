...
- **Updated documentation philosophy** — All README, DOCUMENTATION, docs HTML, and .butter spec files now reflect Butter's core purpose: a specification language that communicates intent to AI agents for higher first-pass accuracy.
